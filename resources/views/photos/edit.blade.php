    ...
    <div class="container">
        <div class="col-lg-6 mb-5">
            ...
            <form action="{{ route('photos.update', $photo->id) }}" method="post" enctype="multipart/form-data">
                ...
                {{-- Input Photo --}}
                <div class="mb-4">
                    <img src="{{ asset($photo->photo) }}" alt="{{ $photo->nama }}" class="photo-preview img-fluid rounded-3 mb-3 col-sm-6 d-block">
                    <div class="col-lg-6">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control p-3 @error('nama') is-invalid @enderror" value="{{ old('nama', $photo->nama) }}">
                    @error('nama')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="body" id="body" class="form-control p-3 @error('body') is-invalid @enderror" value="{{ old('body', $photo->body) }}">
                    @error('body')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-5 form-check form-switch">
                    ...
                    <input type="checkbox" name="publish" id="publish" class="form-check-input p-3 @error('publish') is-invalid @enderror" 
                        {{ old('publish', $photo->publish) ? 'checked' : '' }} value="1">
